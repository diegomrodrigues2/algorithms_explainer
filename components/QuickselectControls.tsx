  ...
  return (
    <div className="bg-slate-800 p-4 rounded-lg shadow-lg">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
        ...
        {/* K Selector */}
        <div className="space-y-2">
          <label htmlFor="kValue" className="block text-sm font-medium text-slate-300">
            Buscar k-ésimo menor: <span className="font-bold text-cyan-400">{k}</span>
          </label>
          <input
            id="kValue"
            type="range"
        ...
        <div className="text-center sm:text-right">
            {foundValue !== null ? (
                 <p className="text-lg font-semibold text-slate-200">
                    Valor Encontrado: <span className="font-mono text-emerald-400 text-2xl">{foundValue}</span>
                </p>
            ) : (
...
export default QuickselectControls;
