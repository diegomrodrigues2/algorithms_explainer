...
const TextSegmentationMemoizedControls = ({
  text,
  onTextChange,
  dictionary,
  onDictionaryChange,
    ...
    <div className="bg-slate-800 p-4 rounded-lg shadow-lg">
      ...
      <div className="mt-6 flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <div className="text-center sm:text-right bg-slate-900/50 p-3 rounded-lg flex-grow">
            {isFinished ? (
                 result ? (
                    <p className="text-lg font-semibold text-emerald-400">Solução Encontrada!</p>
                 ) : (
                    <p className="text-lg font-semibold text-red-400">Nenhuma Solução.</p>
                 )
            ) : (
...
export default TextSegmentationMemoizedControls;