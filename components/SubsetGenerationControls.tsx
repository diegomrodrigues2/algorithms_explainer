...
const SubsetGenerationControls = ({
  elements,
  onElementsChange,
  speed,
  onSpeedChange,
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
        <div className="space-y-2">
          ...
          <input
            ...
            type="text"
            value={elements}
            onChange={(e) => onElementsChange(e.target.value)}
      ...
      <div className="mt-6 flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <div className="text-center sm:text-right bg-slate-900/50 p-3 rounded-lg flex-grow">
            <p className="text-lg font-semibold text-slate-200">
                Subconjuntos: <span className="font-mono text-emerald-400 text-2xl">{foundCount} / {totalCount}</span>
            </p>
        </div>
      </div>
    </div>
...
export default SubsetGenerationControls;