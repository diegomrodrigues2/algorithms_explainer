  ...
  return (
    <div className="bg-slate-800 p-4 rounded-lg shadow-lg">
      ...
      <div className="mt-6 flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <div className="text-center sm:text-right bg-slate-900/50 p-3 rounded-lg">
            {foundSolution ? (
                 <p className="text-lg font-semibold text-slate-200">
                    Solução: <span className="font-mono text-emerald-400 text-xl">[{foundSolution.join(', ')}]</span>
                </p>
            ) : (
...
export default SubsetSumControls;