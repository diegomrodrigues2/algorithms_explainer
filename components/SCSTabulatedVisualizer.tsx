...
import { useSCSTabulated } from '../hooks/useSCSTabulated';
import SCSTabulatedControls from './SCSTabulatedControls';
...
export default SCSTabulatedVisualizer;