    ...
    <div className="bg-slate-800 p-4 rounded-lg shadow-lg">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
        <div className="space-y-2">
          <label htmlFor="keys-input" className="block text-sm font-medium text-slate-300">
        ...
        <div className="space-y-2">
           <label htmlFor="freqs-input" className="block text-sm font-medium text-slate-300">
        ...
        <div className="text-center sm:text-right bg-slate-900/50 p-3 rounded-lg flex-grow">
            {totalCost !== null ? (
                 <p className="text-lg font-semibold text-slate-200">
                    Custo Ótimo: <span className="font-mono text-emerald-400 text-2xl">{totalCost}</span>
                </p>
            ) : (
