    ...
    <div className="bg-slate-800 p-4 rounded-lg shadow-lg">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
        <div className="space-y-2">
          <label htmlFor="stringA-input" className="block text-sm font-medium text-slate-300">
            String A (máx 10)
          </label>
          <input
            id="stringA-input"
         ...
         <div className="space-y-2">
          <label htmlFor="stringB-input" className="block text-sm font-medium text-slate-300">
            String B (máx 10)
          </label>
          <input
            id="stringB-input"
...
export default EditDistanceControls;
