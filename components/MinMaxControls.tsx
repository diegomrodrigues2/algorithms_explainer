  ...
  return (
    <div className="bg-slate-800 p-4 rounded-lg shadow-lg">
      ...
      <div className="mt-6 flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <div className="flex flex-wrap justify-center sm:justify-end gap-4 sm:gap-6 text-center sm:text-right">
             <p className="text-lg font-semibold text-slate-200">
                Comparações: <span className="font-mono text-amber-400 text-2xl">{comparisonCount}</span>
            </p>
             <p className="text-lg font-semibold text-slate-200">
                Min: <span className="font-mono text-cyan-400 text-2xl">{minValue ?? '-'}</span>
            </p>
             <p className="text-lg font-semibold text-slate-200">
                Max: <span className="font-mono text-red-400 text-2xl">{maxValue ?? '-'}</span>
            </p>
        </div>
      </div>
    </div>
