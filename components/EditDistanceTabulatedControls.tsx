...
const EditDistanceTabulatedControls = ({
  stringA,
  onStringAChange,
  stringB,
  onStringBChange,
    ...
    <div className="bg-slate-800 p-4 rounded-lg shadow-lg">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
        <div className="space-y-2">
          <label htmlFor="stringA-input-tab" className="block text-sm font-medium text-slate-300">
            String A (máx 10)
          </label>
          <input
            id="stringA-input-tab"
            type="text"
            value={stringA}
         ...
         <div className="space-y-2">
          <label htmlFor="stringB-input-tab" className="block text-sm font-medium text-slate-300">
            String B (máx 10)
          </label>
          <input
            id="stringB-input-tab"
            type="text"
            value={stringB}
            onChange={(e) => onStringBChange(e.target.value)}
            className="w-full px-3 py-2 bg-slate-700 border border-slate-600 rounded-md text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-cyan-500 disabled:opacity-50"
            placeholder="ex: sitting"
            disabled={isPlaying}
            maxLength={10}
          />
        </div>
        ...
        <div className="col-span-full space-y-2">
          <label htmlFor="speed-tab" className="block text-sm font-medium text-slate-300">
      ...
      <div className="mt-6 flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <div className="text-center sm:text-right bg-slate-900/50 p-3 rounded-lg flex-grow">
             <p className="text-lg font-semibold text-slate-200">
                Distância: <span className="font-mono text-emerald-400 text-2xl">{distance ?? '-'}</span>
            </p>
        </div>
      </div>
    </div>
...
export default EditDistanceTabulatedControls;